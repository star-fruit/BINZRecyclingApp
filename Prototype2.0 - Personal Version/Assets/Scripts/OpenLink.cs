...
public class OpenLink : MonoBehaviour
{
    ...
    public void OpenTinCan()
    {
        Application.OpenURL("https://app06.ottawa.ca/cgi-bin/search/recycle/q.pl?q=Tin+Cans&lang=en");
    }

    public void OpenEggCarton()
    {
        Application.OpenURL("https://app06.ottawa.ca/online_services/recycling/items/199_en.html");
    }
}
